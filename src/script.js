...
(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'consulting.services.teams.desc':      'Hands-on workshops and 1:1 coaching for teams and individuals. Whether you work at a company or independently, I help you master tools like Claude Code, Claude Desktop, GitHub Copilot, and Codex; so you can exceed your own expectations and ship significantly faster.',
      'consulting.services.sdlc.title':      'AI-driven development lifecycle',
      'consulting.services.sdlc.desc':       'From context engineering to AI-augmented code review with Claude Code CLI, I help engineering teams reshape their SDLC to ship faster, with fewer regressions and higher developer confidence.',
      'consulting.services.tools.title':     'In-house AI tooling',
      'consulting.services.tools.desc':      'Design and build internal AI-powered tools using Claude Code, Codex, or Copilot as foundations; automating repetitive tasks, surfacing insights, and accelerating your team without sending data to third-party SaaS.',
      'consulting.services.strategy.title':  'AI strategy & enablement',
      'consulting.services.strategy.desc':   'Not sure where to start? I audit your current workflows, identify the highest-leverage AI opportunities, and give you a concrete, prioritised roadmap; not just a slide deck.',
      ...
      'consulting.services.intro.desc':      'Not sure what you need yet? That\'s fine. A free, no-strings chat is often all it takes to find the right path forward.',
    ...
    pt: {
      ...
      'consulting.services.teams.desc':      'Workshops práticos e mentoria individual para times e profissionais autônomos. Seja em uma empresa ou por conta própria, te ajudo a dominar ferramentas como Claude Code, Claude Desktop, GitHub Copilot e Codex; para superar suas próprias expectativas e entregar muito mais rápido.',
      'consulting.services.sdlc.title':      'Ciclo de desenvolvimento orientado por IA',
      'consulting.services.sdlc.desc':       'De context engineering a code review com Claude Code CLI, ajudo times de engenharia a remodelar seu SDLC para entregar mais rápido, com menos regressões e mais confiança.',
      'consulting.services.tools.title':     'Ferramentas de IA internas',
      'consulting.services.tools.desc':      'Projeto e construção de ferramentas internas com IA usando Claude Code, Codex ou Copilot como base; automatizando tarefas repetitivas, gerando insights e acelerando seu time sem enviar dados para SaaS de terceiros.',
      'consulting.services.strategy.title':  'Estratégia e capacitação em IA',
      'consulting.services.strategy.desc':   'Não sabe por onde começar? Faço um diagnóstico dos seus fluxos atuais, identifico as oportunidades de maior impacto com IA e entrego um roadmap concreto e priorizado; não só slides.',
      ...
      'consulting.services.intro.desc':      'Ainda não sabe o que precisa? Tudo bem. Uma conversa rápida e sem compromisso é muitas vezes o suficiente para encontrar o caminho certo.',
    ...
    de: {
      ...
      'consulting.services.teams.desc':      'Praxisnahe Workshops und 1:1-Coaching für Teams und Einzelpersonen. Ob im Unternehmen oder selbstständig, ich helfe dir, Tools wie Claude Code, Claude Desktop, GitHub Copilot und Codex zu meistern; damit du deine eigenen Erwartungen übertriffst und deutlich schneller lieferst.',
      'consulting.services.sdlc.title':      'KI-getriebener Entwicklungszyklus',
      'consulting.services.sdlc.desc':       'Von Context Engineering bis KI-gestütztem Code Review mit der Claude Code CLI helfe ich Engineering-Teams, ihren SDLC umzugestalten; für schnellere Lieferung, weniger Regressionen und höheres Vertrauen.',
      'consulting.services.tools.title':     'Interne KI-Werkzeuge',
      'consulting.services.tools.desc':      'Design und Entwicklung interner KI-Tools auf Basis von Claude Code, Codex oder Copilot; repetitive Aufgaben automatisieren, Erkenntnisse liefern und dein Team beschleunigen, ohne Daten an Drittanbieter zu senden.',
      ...
      'consulting.services.intro.desc':      'Noch nicht sicher, was du brauchst? Kein Problem. Ein kurzes, unverbindliches Gespräch reicht oft aus, um den richtigen Weg zu finden.',
    ...
    es: {
      ...
      'consulting.services.teams.desc':      'Talleres prácticos y coaching 1:1 para equipos e individuos. Tanto si trabajas en una empresa como de forma independiente, te ayudo a dominar herramientas como Claude Code, Claude Desktop, GitHub Copilot y Codex; para superar tus propias expectativas y entregar mucho más rápido.',
      'consulting.services.sdlc.title':      'Ciclo de desarrollo impulsado por IA',
      'consulting.services.sdlc.desc':       'Desde context engineering hasta revisión de código con Claude Code CLI, ayudo a los equipos de ingeniería a rediseñar su SDLC para entregar más rápido, con menos regresiones y mayor confianza.',
      'consulting.services.tools.title':     'Herramientas de IA internas',
      'consulting.services.tools.desc':      'Diseño y desarrollo de herramientas internas con IA usando Claude Code, Codex o Copilot como base; automatizando tareas repetitivas, generando insights y acelerando a tu equipo sin enviar datos a SaaS de terceros.',
      ...
      'consulting.services.intro.desc':      '¿Aún no sabes qué necesitas? No pasa nada. Una conversación breve y sin compromiso suele ser suficiente para encontrar el camino correcto.',
