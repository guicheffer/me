...
(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'about.bio':        'I\'m a Senior Staff Software Engineer @ <a href="https://www.hellofresh.de/" target="_blank" rel="noopener noreferrer">HelloFresh</a>, leading GenAI enablement, shaping an AI-driven software development lifecycle, and applying context engineering best practices along the way. Passionate about JavaScript, complex frontend applications, and great user experiences — plus a fan of chocolates.',
      ...
      'quiz.yes':                  'Yes',
      'quiz.no':                   'No',
      'quiz.unsure':               'Not sure',
      'q1':                        'Do you feel your team is spending too much time on work that AI could handle?',
      'q2':                        'Have you tried AI tools but struggled to get consistent, reliable results?',
      'q3':                        'Are you unsure which AI tools or approaches are right for your situation?',
      ...
      'prices.cta.contact':         'Get in touch',
    ...
    pt: {
      ...
      'about.bio':        'Sou Senior Staff Software Engineer na <a href="https://www.hellofresh.de/" target="_blank" rel="noopener noreferrer">HelloFresh</a>, liderando a adoção de GenAI, definindo um ciclo de desenvolvimento de software orientado por IA e aplicando boas práticas de context engineering no caminho. Apaixonado por JavaScript, aplicações frontend complexas e ótimas experiências de usuário — e fã de chocolates.',
      ...
      'quiz.yes':                  'Sim',
      'quiz.no':                   'Não',
      'quiz.unsure':               'Não tenho certeza',
      'q1':                        'Seu time perde tempo com trabalho que a IA poderia assumir?',
      'q2':                        'Já tentou usar ferramentas de IA mas os resultados são inconsistentes?',
      'q3':                        'Está em dúvida sobre quais ferramentas ou abordagens de IA fazem sentido pra você?',
      ...
      'prices.intro':              'Cada projeto é diferente, então esses são pontos de partida, sem regras fixas. A gente define o formato certo juntos antes de qualquer coisa.',
      ...
      'prices.cta.contact':         'Entrar em contato',
    ...
    de: {
      ...
      'about.bio':        'Ich bin Senior Staff Software Engineer bei <a href="https://www.hellofresh.de/" target="_blank" rel="noopener noreferrer">HelloFresh</a>, leite die GenAI-Einführung, gestalte einen KI-gestützten Software-Entwicklungszyklus und wende dabei Best Practices im Context Engineering an. Leidenschaftlich für JavaScript, komplexe Frontend-Anwendungen und großartige Nutzererlebnisse — und ein Schokoladenliebhaber.',
      ...
      'consulting.contact.sub':              'kein Commitment, kein Pitch-Deck.',
      ...
      'quiz.yes':                  'Ja',
      'quiz.no':                   'Nein',
      'quiz.unsure':               'Bin nicht sicher',
      'q1':                        'Verliert dein Team Zeit mit Aufgaben, die KI übernehmen könnte?',
      'q2':                        'Hast du KI-Tools ausprobiert, aber die Ergebnisse sind inkonsistent?',
      'q3':                        'Weißt du nicht, welche KI-Tools oder Ansätze für deine Situation passen?',
      ...
      'prices.cta.contact':         'Kontakt aufnehmen',
    ...
    es: {
      ...
      'quiz.yes':                  'Sí',
      'quiz.no':                   'No',
      'quiz.unsure':               'No estoy seguro',
      'q1':                        '¿Tu equipo pierde tiempo en trabajo que la IA podría asumir?',
      'q2':                        '¿Has probado herramientas de IA pero los resultados son inconsistentes?',
      'q3':                        '¿No sabes qué herramientas o enfoques de IA tienen sentido para ti?',
      ...
      'prices.cta.contact':         'Ponerse en contacto',
  ...
  function applyLang(lang, persist) {
    ...
    // Expose translations for inline scripts (quiz)
    window.__QUIZ_TRANS__ = window.__QUIZ_TRANS__ || {};
    window.__QUIZ_TRANS__[lang] = t;
