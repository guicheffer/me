...
(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'consulting.contact.sub':              'Pick a channel and let\'s figure out how I can help.',
    ...
    pt: {
      ...
      'consulting.contact.sub':              'Escolha um canal e vamos descobrir como posso ajudar.',
    ...
    de: {
      ...
      'consulting.contact.sub':              'Wähl einen Kanal und wir finden heraus, wie ich helfen kann.',
    ...
    es: {
      ...
      'consulting.contact.sub':              'Elige un canal y descubramos cómo puedo ayudarte.',
