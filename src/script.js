...
(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'consulting.contact.sub':              'No commitment. No pitch deck.',
    ...
    pt: {
      ...
      'consulting.contact.sub':              'Sem compromisso. Sem pitch deck.',
    ...
    de: {
      ...
      'consulting.contact.sub':              'Kein Commit. Kein Pitch-Deck.',
    ...
    es: {
      ...
      'consulting.contact.sub':              'Sin compromiso. Sin pitch deck.',
